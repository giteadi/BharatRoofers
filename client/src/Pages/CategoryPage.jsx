...
const CategoryPage = () => {
  ...
  return (
    <div className="container mx-auto mt-4 p-4 m-20">
    <h1 className="text-2xl font-bold mb-4">Filtered Properties</h1>
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
      {filteredProperties.length > 0 ? (
        filteredProperties.map(property => (
          <div
            className="card bg-white shadow-lg rounded-lg overflow-hidden transform transition-transform hover:scale-105 hover:shadow-xl duration-300 w-full max-w-xs focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 focus:ring-offset-gray-100"
            key={property.id}
          >
