    ...
    return (
        <div className="w-full">
            ...
            <div className="h-20 flex flex-col md:flex-row relative flex-wrap justify-center md:justify-start">
                <div className="text-white flex justify-center flex-wrap space-x-2 md:space-x-20 text-md bg-black opacity-90 font-semibold rounded-lg py-2 px-1 ">
            ...
            <div className="absolute top-[5.4rem] md:top-[3.4rem] bg-white p-2 md:p-4 flex flex-col md:flex-row w-full rounded-lg md:rounded-full space-y-2 md:space-y-0">
                ...
                <div className="flex flex-grow">
                    <input 
                        ...
                        placeholder="Search..."
                    />
                    <button className="bg-green-500 text-white px-4 rounded-r-md">Search</button>
                </div>
            </div>
        </div>
    );
